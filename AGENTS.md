...
Если добавляется новый подпакет (например, `desktop/` в итерации 7) — создай в нём свой `AGENTS.md` с инструкциями, специфичными для подпакета. Агенты читают ближайший AGENTS.md в дереве каталогов.
